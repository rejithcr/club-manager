  ...
  return (
    <Stack screenOptions={{
      ...
      <Stack.Screen
        ...
        options={{
          headerTitle: () => <StackHeader header={"Member Details"} rightText={clubInfo?.clubName} logo={clubInfo?.logo} />,
          headerShown: true
        }}
      />
      <Stack.Screen
        ...
        options={{
          headerTitle: () => <StackHeader header={"Member Attributes"} rightText={clubInfo?.clubName} logo={clubInfo?.logo} />,
          headerShown: true
        }}
      />
      <Stack.Screen
        ...
        options={{
          headerTitle: () => <StackHeader header={"Edit Club Level Attributes"} rightText={clubInfo?.clubName} logo={clubInfo?.logo} />,
          headerShown: true
        }}
      />
    </Stack>
