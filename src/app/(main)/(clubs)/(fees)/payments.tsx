  ...
  const selectItem = () => {
    ...
    props.setpaymentStatusUpdates(
      (
        ...
        const initialPaymentStatus = props.feeByMembers?.find(
          (item: { clubFeePaymentId: number }) => item.clubFeePaymentId == props.clubFeePaymentId
        );
        if (item) {
          item.paid = !isSelected;
        } else {
          item = {
            clubFeePaymentId: props.clubFeePaymentId,
            paid: !isSelected,
