    ...
    <Provider store={store}>
      <ThemeContext.Provider value={{ theme, setTheme }}>
        ...
        <UserContext.Provider value={{ userInfo, setUserInfo }}>
          <InitialiseApp memberId={userInfo?.memberId}>
...
function InitialiseApp({ children, memberId }: { children: React.ReactNode, memberId: number | undefined }) {
  usePushNotifications(memberId);
  return <>{children}</>;
}
